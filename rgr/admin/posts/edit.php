        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post" enctype="multipart/form-data">
                ...
                if(isset($post) && is_array($post)) {
                    // Проверяем существование $post и что это массив
                ?>
                ...
                <?php } else {
                    echo "Данные статьи не найдены"; // Сообщение об отсутствии данных
                }
                ?>
                <div class="col">
                ...
                <div class="col col-6">
                    <button name="edit_post" class="btn btn-primary" type="submit">Сохранить статью</button>
                </div>
            </form>
        </div>
